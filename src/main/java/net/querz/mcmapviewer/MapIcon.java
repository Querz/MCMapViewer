...
public enum MapIcon {
	...
	BANNER_WHITE("white", 0xffffff, 80, 0),
	BANNER_ORANGE("orange", 0xffa500, 88, 0),
	BANNER_MAGENTA("magenta", 0xff00ff, 96, 0),
	BANNER_LIGHT_BLUE("light_blue", 0xadd8e6, 104, 0),
	BANNER_YELLOW("yellow", 0xffff00, 112, 0),
	BANNER_LIME("lime", 0x00ff00, 120, 0),
	BANNER_PINK("pink", 0xffc0cb, 0, 8),
	BANNER_GRAY("gray", 0x808080, 8, 8),
	BANNER_LIGHT_GRAY("light_gray", 0xd3d3d3, 16, 8),
	BANNER_CYAN("cyan", 0x00ffff, 24, 8),
	BANNER_PURPLE("purple", 0x800080, 32, 8),
	BANNER_BLUE("blue", 0x0000ff, 40, 8),
	BANNER_BROWN("brown", 0xa52a2a, 48, 8),
	BANNER_GREEN("green", 0x008000, 56, 8),
	BANNER_RED("red", 0xff0000, 64, 8),
	BANNER_BLACK("black", 0x000000, 72, 8),
